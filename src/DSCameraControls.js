    ...
    homeCamera() {
        if (this.animateTween === 0) {
            ...
            if (this.closeEnough(this.cameraHomePosition, this.camera.position) && this.closeEnough(this.cameraHomeLookat, this.orbitControls.target)) {
                ...
                if (this.closeEnough(this.cameraHomePosition, this.cameraBackupPosition) && this.closeEnough(this.cameraHomeLookat, this.cameraBackupLookat)) return;

                // it is currently looking at home, go back to previous
                ...
                this.cameraBackupLookat.copy(this.orbitControls.target);
